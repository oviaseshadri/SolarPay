    ...
    <div className="flex mf:flex-row flex-col items-center justify-between md:p-20 py-12 px-4">
      <div className="flex-1 flex flex-col justify-start items-center">
        ...
        <p className="text-center my-2 text-white font-light md:w-9/12 w-full text-base">
          The best choice for the fastest, trustless utility bill payment experience, powered by web3.
        </p>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-start items-center">
        ...
        <ServiceCard
          ...
          subtitle="You consumption is directly stored on chain with no human intervention"
        />
        <ServiceCard
          color="bg-[#F84550]"
